						...
						function LogSheet2()
						{
                                ...
                                var vechNo,routeNo,FromLoc,FromTime,ToLoc,count,wname,ch1;
								...
								fn_Inner2_issue();
     							...
     							wname=document.getElementById("txtworkername").value;
...
//								var end	= document.getElementById("End_cat_code").value+document.getElementById("txtendSNo").value;
							...
							function fn_Inner2_issue()
		                	{
								...
								var txtworkername = document.getElementById("txtworkername").value;
...
//								}
								...
								New_Cell_4.innerHTML = txtworkername;
...
document.getElementById("Hid_Rec").value = Recs +''+ subrackno + '|' + IrouteNo + '|' + txtworkername  + '|' + ItoLoc +  '|'  + IFromLoc +  '|' + refNo +  '|' + isReturnVal +  '^'
								...
								document.getElementById("txtworkername").value="";
