						...
						function LogSheet_repairrecev()
						{
    							...
    							itemn=document.getElementById("txtitem").value;
     							...
     							toloc=document.getElementById("txtapproveby").value;
						}
							...
							function fn_Inner2_receive()
		                	{
								...
								var app1 = document.getElementById("txtapproveby").value;
								...
								document.getElementById("txtapproveby").value="";
								}
								else
								{
