...
//							else if(parseInt(document.getElementById("Start_cat_code").value+document.getElementById("txtstNo").value) > parseInt(document.getElementById("End_cat_code").value+document.getElementById("txtendSNo").value))
//						{	
...
//						}
				...
				function fn_Calc()
			{
				...
				//alert(document.getElementById("txtendSNo").value)
				 var end	= parseFloat(document.getElementById("txtendSNo").value);
				 var start =parseFloat(document.getElementById("txtstNo").value);
				 //alert(end);
				 
				 	 var tot = ((end) -eval(start)+1)
				 //alert(tot)
						count=str.replace(/\+0.15/,"");
					    count1=0.15;
					    count2=(eval(count)- eval(count1)+eval((count1)));
						//document.getElementById("totalTicket").value +=parseFloat(document.getElementById("End_cat_code").value+document.getElementById("txtendSNo").value) -parseFloat(document.getElementById("Start_cat_code").value+document.getElementById("txtstNo").value)+1 ;
					   // document.getElementById("totalTicket").value =(eval(end)-eval((start)))+1 ;
				      // alert(count)
				        //document.getElementById("totalTicket").value =(eval(document.getElementById("txtendSNo").value)-eval(document.getElementById("txtstNo").value)) ;
				        document.getElementById("totalTicket").value =tot ;
					   // alert(document.getElementById("totalTicket").value)					    					    //alert(eval(document.getElementById("txtendSNo").value));
					    //alert(parseInt(document.getElementById("txtstNo").value));
					    document.getElementById("Amt").value = (count2 * eval(document.getElementById("totalTicket").value)) ;
				        //parseInt(document.getElementById("txtendSNo").value)
				        //
				       //alert(document.getElementById("totalTicket").value)
				}
					if (search.length != 2)
			    {
			    
			     var end1	= parseFloat(document.getElementById("txtendSNo").value);
				 var start1 =parseFloat(document.getElementById("txtstNo").value);
				////alert(end);
				 //
				 	 var tot1 = ((end1) -eval(start1)+1)
						 ...
						 document.getElementById("totalTicket").value =tot1 ;
