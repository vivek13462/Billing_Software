        ...
        //								fn_Calc();
								        fn_Inner();
     							        ...
     							        CalFair=document.getElementById("txtFair").innerHTML;
                                      }						
...
//						}
//				
//					 // else if(document.getElementById("txtstNo").value > document.getElementById("txtendSNo").value)
//					//	{	
//							 //alert('Starting Sr No. should be less than ending Sr No. 1111111')
//							 //return false;
//						//}
//							 else
//						 {			
...
//							//{
								...
								var ICalFair   = document.getElementById("txtFair").innerHTML;
...
//alert("Hi");
								New_Cell_1.innerHTML = IrouteNo;
								New_Cell_2.innerHTML = IFromLoc;
								New_Cell_3.innerHTML = IToLoc;
								New_Cell_4.innerHTML = ICalKm;
								New_Cell_5.innerHTML = ICalFair;
								New_Cell_6.innerHTML = "<IMG Type='Button' class='Button' src='../images/icon_delete.gif' Value='Delete' OnClick='Fn_Delete("+P_Row.rowIndex+")'>"
								...
								document.getElementById("Hid_Rec").value = Recs +''+ IrouteNo + '|' + IFromLoc + '|' + IToLoc +'|' + ICalKm + '|' + ICalFair + '^'
								
								document.getElementById("txtroute").value = "";
								document.getElementById("ddlfrom").value="";
								document.getElementById("ddlto").value="";
								document.getElementById("txtkm").innerHTML = "";
								document.getElementById("txtFair").innerHTML = "";
